...
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.26, 2025-10-30
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL VXXXXX(P(0,3),MDL_MZ,+1,+1*IC(3),W(1,5))  !  count 6
      CALL VXXXXX(P(0,3),MDL_MZ, 0,+1*IC(3),W(1,6))  !  count 6
      CALL VXXXXX(P(0,3),MDL_MZ,-1,+1*IC(3),W(1,7))  !  count 6
      CALL VXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,8))  !  count 8
      CALL VXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,9))  !  count 8
      CALL FFV2_5_2(W(1,1),W(1,5),-GC_50,GC_58,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV2_5_2(W(1,1),W(1,6),-GC_50,GC_58,ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL FFV2_5_2(W(1,1),W(1,7),-GC_50,GC_58,ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV2_5_2(W(1,2),W(1,5),-GC_50,GC_58,ZERO,FK_ZERO,W(1,13))  !  count 2
      CALL FFV2_5_2(W(1,2),W(1,6),-GC_50,GC_58,ZERO,FK_ZERO,W(1,14))  !  count 2
      CALL FFV2_5_2(W(1,2),W(1,7),-GC_50,GC_58,ZERO,FK_ZERO,W(1,15))  !  count 2
      CALL FFV1P1N_1(W(1,4), W(1,8), GC_11, TMP(1))
      call CombineAmp(3,
     & (/6,4,2/), 
     & (/10,11,12/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,4), W(1,9), GC_11, TMP(1))
      call CombineAmp(3,
     & (/5,3,1/), 
     & (/10,11,12/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,3), W(1,8), GC_11, TMP(1))
      call CombineAmp(3,
     & (/12,10,8/), 
     & (/13,14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,3), W(1,9), GC_11, TMP(1))
      call CombineAmp(3,
     & (/11,9,7/), 
     & (/13,14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,FK_ZERO,W(1,16))  !  count 3
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO,FK_ZERO,W(1,17))  !  count 3
      CALL FFV1_2(W(1,2),W(1,8),GC_11,ZERO,FK_ZERO,W(1,18))  !  count 3
      CALL FFV1_2(W(1,2),W(1,9),GC_11,ZERO,FK_ZERO,W(1,19))  !  count 3
      CALL FFV2_5P1N_1(W(1,4), W(1,5), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/16,17/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,6), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/16,17/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,4), W(1,7), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/16,17/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,3), W(1,5), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/12,11/), 
     & (/18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,3), W(1,6), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/10,9/), 
     & (/18,19/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,3), W(1,7), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/8,7/), 
     & (/18,19/),
