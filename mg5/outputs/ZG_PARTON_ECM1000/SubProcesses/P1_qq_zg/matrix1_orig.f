...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_2(W(1,1),W(1,3),-GC_50,GC_58,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,2),W(1,4),GC_11,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,3),-GC_50,GC_58,AMP(2))
