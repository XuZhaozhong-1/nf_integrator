...
def main():
    ...
    model = CubeRealNVP(dim=DIM, n_blocks=12, hidden=128)
    ...
    save_nf_checkpoint(out, "results/checkpoints/nf_A_kl.pt")
    plot_loss_curve(out["history"], "results/plots/loss_A_kl.png", title="A: KL")
