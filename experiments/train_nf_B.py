...
def main():
    ...
    out = train_nf(
        ...
        batch_size=16384,
        lr=1e-5,
        loss_name="raw_std_loss",
        device = "cuda" if torch.cuda.is_available() else "cpu",
    )

    save_nf_checkpoint(out, "results/checkpoints/nf_B_raw_std.pt")
    plot_loss_curve(out["history"], "results/plots/loss_B_raw_std.png", title="B: std")
