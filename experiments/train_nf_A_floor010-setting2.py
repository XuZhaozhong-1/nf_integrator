...
def main():
    ...
    model = CubeRealNVP(dim=DIM, n_blocks=20, hidden=256,eps_mix=0.10)
    ...
    save_nf_checkpoint(out, "results/checkpoints/nf_A_kl_floor010-setting2.pt")
    plot_loss_curve(out["history"], "results/plots/loss_A_kl_floor010-setting2.png", title="A: KL_floor010")
