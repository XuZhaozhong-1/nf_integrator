...
def main():
    ...
    model = CubeRealNVP(dim=DIM, n_blocks=12, hidden=128,eps_mix=0.10)
    ...
    save_nf_checkpoint(out, "results/checkpoints/nf_A_kl_floor010.pt")
    plot_loss_curve(out["history"], "results/plots/loss_A_kl_floor010.png", title="A: KL_floor010")
